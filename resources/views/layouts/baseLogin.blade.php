...
<body>
    ...
    do {
        $i = rand(1,8);
    } while (session()->get('oldBg') == $i);
        
        session()->put('oldBg', $i);
    @endphp
    <div class="fade-in" style="background-image: url({{asset('bg'.$i.'.jpg')}}); width:100%;height: 100%;background-size: cover; position: fixed; z-index: -4; top: 20px" ></div>
