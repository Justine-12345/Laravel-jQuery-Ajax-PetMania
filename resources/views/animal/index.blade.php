<div id="AnimalContainer">
    ...
    <div>
     ...
     <br /> <h3 align="center">Animals Table</h3> <br /> 
      
      <div class="info"></div>
      <div id="animalContainerTable" class="container">
       ...
       <table id="animalTable" class="table table-striped table-hover">
          <thead>
            <tr>
              ...
              <th style="color: black;">Animal Category</th>
              <th style="color: black;">Animal Gender</th>
              <th style="color: black;">Animal Age</th>
              <th style="color: black;">Animal Breed</th>
              <th style="color: black;">Animal Health</th>
    ...
    <div class="modal fade" id="animalCreateModal" role="dialog" style="display:none">
     ...
     <form id="animalCreateform" method="post" action="#" enctype="multipart/form-data">
     <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <button id="animalCreateSubmit" type="submit" class="btn btn-primary">Save</button>
                </div>
    </div>
 ...
 <div class="modal fade" id="animalShowModal" role="dialog" style="display:none">
        <div class="modal-dialog modal-lg" >
            <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Show Animal</h4>
                    {{-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> --}}
                </div>
   ...
   <div class="modal fade" id="animalEditModal" role="dialog" style="display:none">
     ...
     <form id="animalEditform" method="#" action="" enctype="multipart/form-data">
     <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="closeModal btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button id="animalEditSubmit" type="submit" class="btn btn-primary">Save</button>
                </div>
    </div>
