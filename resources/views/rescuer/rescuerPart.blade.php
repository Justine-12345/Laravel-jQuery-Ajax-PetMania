<div id="showRescuerModalContent1">
...
Rescuer Profile  <button id="rescuerEditBtn1" type="button" class="" data-toggle="modal" data-target="#rescuerEditModal1" style="background-color:unset;">
      <i class="far fa-edit" style="font-size: 20px; font-weight: 900; color: #00abed; text-shadow: unset;bottom: 3px;position: relative;cursor: pointer;" id="rescuerEditBtn1"></i>
    </button>
</h3>
</div>
...
<div class="modal fade" id="rescuerEditModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Edit Rescuer</h4>
      </div>
    <form id="rescuerEditform1" method="post" action="" enctype="multipart/form-data">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="rescuerEditSubmit1" class="btn btn-primary">Save</button>
      </div>
    </div>
  </div>
</div>
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item" role="presentation">
    <a class="nav-link" id="home-tab" data-toggle="tab" href="#home11" role="tab" aria-controls="home11" aria-selected="true">Profile</a>
  </li>
  <li class="nav-item" role="presentation">
    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile11" role="tab" aria-controls="profile11" aria-selected="false">Rescued</a>
  </li>  
</ul>
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade show " id="home11" role="tabpanel" aria-labelledby="home-tab">
  {{-- Profile --}}
 <table class="table">
  <thead>
    <tr>
  ...
  <div class="tab-pane fade" id="profile11" role="tabpanel" aria-labelledby="profile-tab">
  {{-- rescued --}}
...
{{-- @endif --}}
 <script src="{{asset('js/rescuerPart.js')}}"></script>
</div>
</div>
</div>
</div>
